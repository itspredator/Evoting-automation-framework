...
public class createeven extends Evencreation{
	...
	By registerevtngdtls=By.xpath("//body[1]/table[2]/tbody[1]/tr[1]/td[1]/table[1]/tbody[1]/tr[2]/td[1]/div[2]/div[1]/table[1]/tbody[1]/tr[1]/td[2]/a[1]");
	...
	public void evenformfill(List<Evencreation> even) throws InterruptedException, AWTException
	{
		...
		for (Evencreation evenObj : even) 
		{
			...
			if(Voting_Type.equals("Postal_ballot"))
			{
				...
				/*driver.findElement(logofilebrowse).sendKeys("C:\\Users\\Pinkeshc\\Desktop\\IMAGES\\111436_7.JPG");
				driver.findElement(resolutionfileupload).sendKeys("C:\\Users\\Pinkeshc\\Downloads\\INDUS_NOTICE.pdf");
				driver.findElement(uploadannexture).sendKeys("C:\\Users\\Pinkeshc\\Downloads\\108080 (7).pdf");
				...
				//driver.findElement(okbuttonevencreation).isDisplayed();
			}
			}
